...
@section('page_title', 'Create Blueprint')
...
<div class="breadcrumb">
    <a href="{{ route('blueprints.index') }}">Blueprint List</a> <span>/</span> <span>Create</span>
</div>

<div class="card">
    <form action="{{ route('blueprints.store') }}" method="POST">
        @csrf
        <div class="form-group">
            <label class="form-label">Name / Title</label>
            <input type="text" name="title" class="form-control" required placeholder="Enter Blueprint name...">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="background" id="background_hidden" style="display:none;"></textarea>
        ...
        <div class="form-group">
            ...
            <textarea name="scope" id="scope_hidden" style="display:none;"></textarea>
        ...
        <div class="form-group">
            ...
            <textarea name="out_of_scope" id="out_of_scope_hidden" style="display:none;"></textarea>
            <div id="editor_out_of_scope"></div>
        </div>

        <button type="submit" class="btn-submit">Save Blueprint</button>
    </form>
</div>
@endsection
