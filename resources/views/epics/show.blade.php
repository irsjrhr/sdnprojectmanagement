@extends('layouts.app')
@section('title', 'Epic Details')
@section('page_title', 'Epic Details')
...
<div class="breadcrumb">
    <a href="{{ route('epics.index') }}">Epic List</a> <span>/</span> <span>{{ $record->name ?? $record->title ?? 'Details' }}</span>
</div>

@if($record)
<div class="toolbar">
    <a href="{{ route('epics.edit', $record) }}" class="btn-edit">✏️ Edit Epic</a>
</div>
    ...
    <div>
        <div class="card">
            ...
            <div class="info-group">
                ...
                <div class="info-value">{{ $record->start_date ? $record->start_date->format('d M Y') : '-' }}</div>
            </div>

            <div class="info-group">
                <div class="info-label">End Date</div>
                <div class="info-value">{{ $record->end_date ? $record->end_date->format('d M Y') : '-' }}</div>
            </div>
        </div>
    </div>
</div>
