@extends('layouts.app')
@section('title', 'Create FSD')
@section('page_title', 'Create FSD')
...
<div class="breadcrumb" style="justify-content: space-between;">
    <div>
        <a href="{{ route('fsds.index') }}">FSD List</a> <span>/</span> <span>Create</span>
    </div>
...
<div class="card">
    <form action="{{ route('fsds.store') }}" method="POST">
        @csrf
        <div class="form-group">
            <label class="form-label">Code</label>
            <input type="text" name="code" class="form-control" required placeholder="Enter FSD code...">
        </div>
        <div class="form-group">
            <label class="form-label">Title</label>
            <input type="text" name="title" class="form-control" required placeholder="Enter FSD title...">
        </div>
        ...
        <button type="submit" class="btn-submit">Save FSD</button>
    </form>
</div>
