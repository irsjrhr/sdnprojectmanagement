...
<div class="breadcrumb">
    <a href="{{ route('permissions.index') }}">Master Permissions</a> <span>/</span> 
...
<div class="form-card">
    <form method="POST" action="{{ route('permissions.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g. manage invoices" autofocus>
            <small style="color:#64748b; margin-top: 6px; display:block;">Use lowercase and spaces (e.g., 'access reports')</small>
        </div>
        
        <div style="display:flex;gap:8px;margin-top:8px">
            <a href="{{ route('permissions.index') }}" class="btn-back">← Back</a>
