...
<div class="form-card">
    <form method="POST" action="{{ route('roles.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g. Project Manager" autofocus>
            <small style="color:#64748b; margin-top: 6px; display:block;">Use capital letters (e.g., 'Project Manager')</small>
        </div>
